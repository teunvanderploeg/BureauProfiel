...
class QuestionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        QuestionFactory::new()->create([
            ...
            "rules" => 'required|in:Alleenstaand,Samenwonend,Gehuwd,Inwonend bij ouders,Other',
        ]);
        QuestionFactory::new()->create([
        ...
        QuestionFactory::new()->create([
            ...
            "rules" => 'required|in:geen,basisonderwijs,vmbo/mavo,havo/vwo,mbo-1/mbo-2,mbo-3,mbo-4,hbo,universitair,other',
        ]);
        QuestionFactory::new()->create([
            ...
            "rules" => 'required|in:student,werkzaam,niet werkzaam',
        ]);
        QuestionFactory::new()->create([
            ...
            "rules" => 'nullable|required_if:dagelijkse-bezigheid,student|in:vmbo/mavo,havo/vwo,mbo-1/mbo-2,mbo-3,mbo-4,hbo,universitair,other',
        ]);
        QuestionFactory::new()->create([
        ...
        QuestionFactory::new()->create([
            ...
            "rules" => 'nullable|required_if:dagelijkse-bezigheid,werkzaam|in:fulltime,parttime',
        ]);
        QuestionFactory::new()->create([
            ...
            "rules" => 'nullable|required_if:dagelijkse-bezigheid,werkzaam|in:loondienst,zelfstandig ondernemer,Other',
        ]);
        QuestionFactory::new()->create([
        ...
        QuestionFactory::new()->create([
            ...
            "rules" => 'nullable|required_if:niet-werkzaam-uitkering,on|in:Werkeloosheidsuitkering (WW),Bijstandsuitkering,WAO / WIA / Wajong,AOW,Other',
        ]);
        QuestionFactory::new()->create([
        ...
        QuestionFactory::new()->create([
            ...
            "rules" => 'nullable|required_if:voor-het-laatst-meegedaan-aan-een-maktonderzoek,on|in:korter dan 6 maanden geleden,langer dan 6 maanden geleden',
        ]);
        QuestionFactory::new()->create([
            ...
            "rules" => 'required|in:Via google/zoekmachine,Via onze website,Via een bekende die al ingeschreven staat,Via onze promotie dame,Via advertentie kaartje,Other',
        ]);
        QuestionFactory::new()->create([
